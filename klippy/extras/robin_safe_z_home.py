...
class RobinSafeZHome:
    def __init__(self, config):
        ...
        self.gcode.register_command("R28", self.prev_G28)
        self.gcode.register_command("G28", self.cmd_G28)

        if config.has_section("homing_override"):
            raise config.error("homing_override and robin_safe_z_home cannot"
    ...
    def cmd_G28(self, gcmd):
        ...
        if need_z:
            ...
            # Home Z
            ###### EDIT: ######
            # depends on [stable_z_home] in config
            self.gcode.run_script_from_command('STABLE_Z_HOME')
            ###### /EDIT ######
            ###### OLD: ######
